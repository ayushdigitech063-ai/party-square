        ...
        <div className="bg-white rounded-3xl overflow-hidden shadow-lg border border-red-200/60 grid grid-cols-1 md:grid-cols-2 gap-8 p-6 md:p-10">
          ...
          <div className="flex flex-col justify-between space-y-6">
            ...
            <div className="pt-6 border-t border-neutral-100 flex items-center justify-between">
              ...
              <Link
                href="/contact"
                className="bg-neutral-950 hover:bg-red-600 hover:text-white text-white font-bold px-8 py-3.5 rounded-full text-xs uppercase tracking-wider transition shadow-md flex items-center space-x-1"
              >
                <span>Book Now</span>
                <ArrowRight size={14} />
              </Link>
