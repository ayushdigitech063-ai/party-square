...
export default function ChristmasProductDetail({
  params,
}: PageProps) {
  ...
  const whatsIncluded: string[] =
    (product as any).whatsIncluded ?? [
      "Premium Christmas decoration setup",
  ...
  const ratingBreakdown: {
    ...
    const relatedProducts = christmasProducts.filter(
...
<section className="grid grid-cols-1 lg:grid-cols-[1.45fr_1fr] gap-8 bg-white border-x border-b border-[#eadba7] rounded-b-[30px] p-8">
            ...
            <section className="mt-5 grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-[#fff9e9] border border-[#eadba7] rounded-[13px] p-6 sm:p-8 flex flex-col justify-center min-h-[220px]">
                ...
                <p className="mt-3 text-[10px] leading-5 text-neutral-500 max-w-[450px]">
                  Create beautiful Christmas celebrations with
        ...
        {activeTab === "faq" && (
          <section className="mt-5 bg-white border border-[#e1ddd7] rounded-[13px] p-6">
            ...
            <p className="text-sm leading-6 text-neutral-600">
              Have questions about setup timing, customization,
              or delivery? Reach out to us before booking and our
              team will guide you through everything.
            </p>
...
{/* =================== RELATED PRODUCTS END =================== */}
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          ...
          <div className="bg-white rounded-[20px] max-w-md w-full p-6 shadow-2xl border border-[#eadba7] text-center relative">
            ...
            <h3 className="mt-4 text-lg font-serif font-bold text-neutral-900">
              Booking Confirmed!
            </h3>

            <p className="mt-2 text-xs leading-5 text-neutral-600 font-light">
              Your order{" "}
            ...
            <div className="mt-5 bg-[#faf8f5] border border-neutral-200 rounded-xl p-4 flex items-center gap-4 text-left">
            ...
            <div className="mt-4 bg-neutral-50 rounded-xl p-4 border border-neutral-200 text-left space-y-2">
              ...
              <div className="border-t border-neutral-200 pt-2 flex justify-between">
                ...
                <span className="text-base font-bold text-[#b45a14]">
                  ₹
                  {totalPrice.toLocaleString()}
                </span>
            ...
            <div className="pt-5 grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className="bg-neutral-100 hover:bg-neutral-200 text-neutral-800 text-[10px] uppercase font-bold py-3 rounded-lg transition cursor-pointer"
              >
                Close
              </button>
              ...
              <Link
                href="/Festivals/christmas/all-products"
                className="bg-[#4b2014] hover:bg-[#602a19] text-white text-[10px] uppercase font-bold py-3 rounded-lg transition flex items-center justify-center cursor-pointer"
              >
