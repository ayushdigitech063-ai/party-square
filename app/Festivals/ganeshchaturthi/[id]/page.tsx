...
const [relatedStart, setRelatedStart] = useState(0);
  ...
  const whatsIncluded: string[] =
    (product as any).whatsIncluded ?? [
      "Premium Ganesh Chaturthi decoration setup",
...
const relatedProducts = ganeshProducts
...
const handleRelatedNext = () => {
  ...
  /* ================================================================ */
  /* ADD TO CART - ORIGINAL QUANTITY LOGIC PRESERVED                  */
  /* ================================================================ */
...
<section className="grid grid-cols-1 lg:grid-cols-[1.45fr_1fr] gap-8 bg-white border-x border-b border-[#eadba7] rounded-b-[30px] p-8">
    ...
    <div className="bg-white">
        ...
        <h2 className="font-serif font-bold text-[24px] sm:text-[27px] leading-[1.12] text-[#090909] max-w-[560px]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-[9px] mt-[20px]">
          ...
          <div className="min-h-[88px] bg-[#fff9e9] rounded-[14px] px-[12px] py-[12px] flex flex-col justify-between">
            ...
            <div className="mt-[10px]">
              <p className="text-[11px] sm:text-[12px] leading-tight font-semibold text-neutral-900">
                Premium Decor
              </p>
            ...
            <section className="mt-5 grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-[#fff9e9] border border-[#eadba7] rounded-[13px] p-6 sm:p-8 flex flex-col justify-center min-h-[220px]">
                ...
                <p className="mt-3 text-[10px] leading-5 text-neutral-500 max-w-[450px]">
                  Create beautiful Ganesh Chaturthi celebrations with
...
<section className="mt-14 mb-10 overflow-hidden">
  ...
  <div className="text-center">
    ...
    <p className="mt-2 text-[11px] sm:text-[13px] text-neutral-500">
      ...
      special Ganesh Chaturthi moments.
    </p>
  </div>
  ...
  <div className="mt-9 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
    ...
    {visibleRelatedProducts.map((item) => (
      <article
        key={item.id}
        className="overflow-hidden rounded-[18px] border border-[#edc95d] bg-white shadow-[0_4px_10px_rgba(0,0,0,0.08)]"
      >
        ...
        <div className="px-4 pt-4 pb-3">
          ...
          <div className="mt-4 border-t border-neutral-100 pt-3 flex items-center justify-between gap-2">
            ...
            <span className="text-[13px] font-extrabold text-[#17100c]">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                onClick={() =>
                  router.push(
                    `/Festivals/ganeshchaturthi/${item.id}`
                  )
                }
                className="h-8 px-4 rounded-full bg-[#b74300] hover:bg-[#943700] text-white text-[10px] font-bold uppercase transition"
              >
                Book
              </button>
