...
export default function IndependenceDayProductDetail({
  params,
}: PageProps) {
  const resolvedParams = use(params);
  const productId = Number(resolvedParams.id);

  const product = independencedayProducts.find(
    (p) => p.id === productId
  );
  ...
  const whatsIncluded: string[] =
    (product as any).whatsIncluded ?? [
      "Premium Independence Day decoration setup",
...
const relatedProducts = independencedayProducts
  .filter((item) => item.id !== product.id && item.id >= 8)
  .slice(0, 8);
  ...
  <section className="grid grid-cols-1 lg:grid-cols-[1.45fr_1fr] gap-8 bg-white border-x border-b border-[#eadba7] rounded-b-[30px] p-8">
     ...
     <div className="bg-white">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-5">
          ...
          <div className="min-h-[105px] bg-[#fff8e8] rounded-[10px] px-3 py-4 flex flex-col justify-between">
            <Sparkles
              size={24}
              strokeWidth={1.8}
      ...
      <div className="space-y-3">
            ...
            <section className="mt-5 grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-[#fff9e9] border border-[#eadba7] rounded-[13px] p-6 sm:p-8 flex flex-col justify-center min-h-[220px]">
                ...
                <p className="mt-3 text-[10px] leading-5 text-neutral-500 max-w-[450px]">
                  Create beautiful Independence Day celebrations with
                  thoughtfully designed decorations and memorable experiences.
                </p>
        ...
        {activeTab === "faq" && (
          <section className="mt-5 bg-white border border-[#e1ddd7] rounded-[13px] p-6">
            ...
            <p className="text-sm leading-6 text-neutral-600">
              Have questions about setup timing, customization, or delivery?
              Reach out to us before booking and our team will guide you
              through everything.
            </p>
    ...
    >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-white rounded-[20px] max-w-md w-full p-6 shadow-2xl border border-[#eadba7]">
            ...
            {isConfirmed ? (
              ...
              <div>
                ...
                <span className="inline-block bg-[#fff3cf] text-[#9d570d] px-3 py-1 rounded-full text-[9px] uppercase tracking-widest font-bold">
                  Order Summary
                </span>

                <h3 className="mt-3 text-xl font-serif font-bold text-neutral-900">
                ...
                <div className="mt-6 bg-[#faf8f5] border border-neutral-200 rounded-xl p-4 flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="mt-1 text-sm font-bold text-[#b45a14]">
                      ₹
                ...
                <div className="grid grid-cols-2 gap-3 mt-6">
                  ...
                  <button
                    ...
                    className="h-11 rounded-lg bg-neutral-100 hover:bg-neutral-200 text-neutral-700 text-[10px] uppercase tracking-wider font-bold transition"
                  >
                    Cancel
                  </button>
                  ...
                  <button
                    ...
                    className="h-11 rounded-lg bg-[#4b2014] hover:bg-[#602a19] text-white text-[10px] uppercase tracking-wider font-bold transition"
                  >
                    Confirm Booking
                  </button>
