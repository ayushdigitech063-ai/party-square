...
export default function JanmashtamiProductDetail({
  params,
}: PageProps) {
  ...
  const product = janmashtamiProducts.find(
    (p) => p.id === productId
  );
...
const [relatedStart, setRelatedStart] = useState(0);
  ...
  const whatsIncluded: string[] =
    (product as any).whatsIncluded ?? [
      "Premium Janmashtami decoration setup",
...
const relatedProducts = janmashtamiProducts
...
const handleRelatedNext = () => {
  setRelatedStart(
    (prev) => (prev + 1) % relatedProducts.length
  );
};
  /* ================================================================ */
  /* HANDLERS                                                         */
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[64px_minmax(0,1.55fr)_minmax(330px,1fr)] gap-3 lg:gap-5">
            ...
            <div className="hidden lg:flex flex-col gap-2">
              ...
              <button
                ...
                className="w-[62px] h-[28px] border border-[#e4ded6] rounded-[6px] flex items-center justify-center text-neutral-400 bg-white hover:text-[#c66a16] transition"
              >
                <ChevronLeft size={14} />
              </button>
            </div>
            ...
            <div>
              <div className="relative overflow-hidden rounded-[10px] bg-[#f5f3ef] h-[310px] sm:h-[420px] lg:h-[455px]">
                ...
                <div className="absolute bottom-3 right-3 bg-black/60 text-white rounded-full px-2.5 py-1 text-[10px] font-medium">
              ...
              <div className="mt-3 w-full border border-[#e9c76a] bg-[#fffdf7] rounded-[10px] px-4 py-3">
                <div className="flex items-center justify-around gap-3 text-[9px] font-semibold text-neutral-500">
                  ...
                  <span className="flex items-center justify-center gap-1.5">
                    <span className="text-[#d88a18] text-[10px]">
                      ✦
                    </span>
            ...
            <div className="px-1 lg:px-2 flex flex-col">
              ...
              <div className="mt-5 flex flex-wrap items-center gap-2">
                ...
                <span className="text-[10px] text-neutral-400 line-through">
                  Retail ₹{originalPrice.toLocaleString()}
                </span>
...
{activeTab === "overview" && (
  ...
  <section className="grid grid-cols-1 lg:grid-cols-[1.45fr_1fr] gap-8 bg-white border-x border-b border-[#eadba7] rounded-b-[30px] p-8">
    ...
    <h2 className="font-serif font-bold text-[20px] sm:text-[22px] leading-[1.12] text-[#090909] max-w-[560px]">
  Turn Your Special Moments Into Magical Memories
</h2>

<p className="mt-[15px] text-[10px] sm:text-[11px] leading-[1.7] text-neutral-700">
  {product.fullDesc}
</p>
<div className="grid grid-cols-2 md:grid-cols-4 gap-[9px] mt-[20px]">

  {/* PREMIUM DECOR */}
  <div className="min-h-[82px] bg-[#fff9e9] rounded-[14px] px-[12px] py-[11px] flex flex-col justify-between">
<Sparkles
  size={24}
  strokeWidth={1.8}
  className="text-[#d95f00]"
/>
    <div className="mt-[9px]">
     <p className="text-[14px] sm:text-[16px] leading-[1.4] font-semibold text-neutral-900">
  Premium Decor
</p>
     <p className="mt-[8px] text-[13px] sm:text-[15px] text-neutral-600">
  &amp; Setup
</p>
    </div>
  </div>
  ...
  {/* VERIFIED */}
  <div className="min-h-[82px] bg-[#fff9e9] rounded-[14px] px-[12px] py-[11px] flex flex-col justify-between">
<div className="w-[32px] h-[32px] rounded-full border-[2px] border-[#d95f00] flex items-center justify-center">
  <Check
    size={17}
    strokeWidth={2}
    className="text-[#d95f00]"
     ...
     <h3 className="font-serif font-bold text-[26px] sm:text-[30px] text-[#18100c] mb-5">
              ...
              <div className="bg-[#fff9e9] border border-[#eadba7] rounded-[13px] p-6 sm:p-8 flex flex-col justify-center min-h-[220px]">
                ...
                <p className="mt-3 text-[10px] leading-5 text-neutral-500 max-w-[450px]">
                  Create beautiful Janmashtami celebrations with
                  thoughtfully designed decorations and memorable
                  experiences.
                </p>
        ...
        {activeTab === "cancellation" && (
          <section className="mt-5 bg-white border border-[#e1ddd7] rounded-[13px] p-6">
            ...
            <p className="text-sm leading-6 text-neutral-600">
              ...
              Cancellations within 48 hours may be subject to a partial
              charge for materials already arranged.
            </p>
        ...
        {activeTab === "faq" && (
          <section className="mt-5 bg-white border border-[#e1ddd7] rounded-[13px] p-6">
            ...
            <p className="text-sm leading-6 text-neutral-600">
              Have questions about setup timing, customization, or
              delivery? Reach out to us before booking and our team
...
<section className="mt-10 sm:mt-12 pb-4">
  ...
  <div className="text-center">
    ...
    <h2 className="mt-4 font-serif text-[26px] sm:text-[31px] font-bold text-[#17100c]">
      Janmashtami Special Products
    </h2>

    <p className="mt-2 text-[11px] sm:text-[13px] text-neutral-500">
      Handpicked festive decorations and celebration essentials for your
      special Janmashtami moments.
    </p>
  ...
  <div className="mt-9 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">

    {visibleRelatedProducts.map((item) => (

      <article
        key={item.id}
        className="group overflow-hidden rounded-[18px] border border-[#edc95d] bg-white shadow-[0_4px_10px_rgba(0,0,0,0.08)] transition-all duration-300 hover:-translate-y-[2px] hover:shadow-[0_8px_18px_rgba(0,0,0,0.12)]"
      >

        {/* IMAGE */}

        <div className="relative h-[220px] overflow-hidden bg-[#f5f2ed]">
          ...
          <button
            type="button"
            aria-label="Add to wishlist"
            className="absolute top-3 right-3 w-9 h-9 rounded-full bg-white shadow flex items-center justify-center text-neutral-600 hover:text-[#b45a14] transition"
          >
            <Heart size={17} />
          </button>
        ...
        <div className="px-4 pt-4 pb-3">
          ...
          <h3 className="font-serif text-[20px] sm:text-[21px] font-bold leading-tight text-[#17100c] truncate">
            {item.name}
          </h3>
          ...
          <p className="mt-2 min-h-[42px] text-[11px] sm:text-[12px] leading-[1.7] text-neutral-500 line-clamp-2">
            {item.desc}
          </p>
          ...
          <div className="mt-4 border-t border-neutral-100 pt-3 flex items-center justify-between gap-2">

            {/* PRICE */}

            <span className="text-[13px] font-extrabold text-[#17100c] whitespace-nowrap">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full bg-[#fff2c8] text-[#b45a14] flex items-center justify-center hover:bg-[#ffe8ae] transition"
              >
                <ShoppingCart
                  size={13}
                  strokeWidth={1.8}
              ...
              <Link
                ...
                className="h-8 px-4 rounded-full bg-[#b74300] hover:bg-[#943700] text-white text-[10px] font-bold uppercase flex items-center justify-center transition"
              >
                Book
              </Link>
  ...
  {relatedProducts.length > 5 && (
    ...
    <div className="mt-8 flex items-center justify-center gap-4">
      ...
      <button
        ...
        className="w-10 h-10 rounded-full bg-[#fff0bd] text-[#a94708] flex items-center justify-center shadow-sm hover:bg-[#ffe6a0] transition"
      >
        <ChevronLeft
          size={18}
          strokeWidth={2}
              ...
              <div>
                ...
                <div className="mt-5 flex items-center gap-4 p-4 rounded-xl border border-neutral-200 bg-[#faf8f5]">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-extrabold text-[#b45a14] mt-1">
                ...
                <div className="grid grid-cols-2 gap-3 mt-6">
                  ...
                  <button
                    ...
                    className="h-11 bg-neutral-100 hover:bg-neutral-200 text-neutral-800 font-bold rounded-lg text-[10px] uppercase tracking-wider transition"
                  >
                    Cancel
                  </button>
                  ...
                  <button
                    ...
                    className="h-11 bg-[#4b2014] hover:bg-[#602a19] text-white font-bold rounded-lg text-[10px] uppercase tracking-wider transition"
                  >
                    Confirm Order
                  </button>
