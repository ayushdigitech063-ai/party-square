  ...
  return (
    <div className="min-h-screen bg-[#FBF9F4] px-6 py-10">
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <Link
          href="/Festivals/janmasthmi/all-products"
          className="inline-flex items-center space-x-2 text-xs font-bold uppercase tracking-wider text-emerald-700 hover:text-neutral-950 bg-white border border-emerald-200 px-4 py-2 rounded-full transition shadow-sm"
        >
          <ArrowLeft size={14} />
        ...
        <div className="bg-white rounded-3xl overflow-hidden shadow-lg border border-emerald-200/60 grid grid-cols-1 md:grid-cols-2 gap-8 p-6 md:p-10">
          ...
          <div className="flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              <span className="bg-emerald-100 text-emerald-800 text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full inline-block">
                Janmashtami Special
              </span>
            ...
            <div className="pt-6 border-t border-neutral-100 flex items-center justify-between">
              ...
              <Link
                href="/contact"
                className="bg-neutral-950 hover:bg-emerald-600 hover:text-white text-white font-bold px-8 py-3.5 rounded-full text-xs uppercase tracking-wider transition shadow-md flex items-center space-x-1"
              >
                <span>Book Now</span>
                <ArrowRight size={14} />
              </Link>
