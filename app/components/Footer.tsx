        ...
        <div className="bg-gradient-to-r from-amber-100/90 to-amber-50/90 backdrop-blur-md border border-amber-300/90 rounded-3xl p-8 md:p-12 mb-16 flex flex-col lg:flex-row items-center justify-between gap-8 shadow-sm">
          ...
          <div className="w-full lg:w-auto flex flex-col sm:flex-row gap-3">
            <input 
              ...
              className="bg-white/90 border border-amber-400 px-5 py-3.5 rounded-full text-sm text-neutral-950 placeholder-neutral-500 focus:outline-none focus:border-amber-700 w-full sm:w-80 shadow-inner font-medium backdrop-blur-sm"
            />
            <button className="bg-neutral-950 hover:bg-amber-700 text-white px-7 py-3.5 rounded-full text-sm font-bold transition flex items-center justify-center space-x-2 shadow-md">
              <span>Subscribe</span>
              <ArrowRight size={15} />
            </button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-16 border-b border-amber-300/70">
          ...
          <div className="lg:col-span-4 space-y-4">
            <h2 className="text-2xl font-serif font-bold tracking-wide text-neutral-950">
              Aesthetic <span className="italic font-normal text-amber-800">Decor</span>
            </h2>
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a href="#" aria-label="Social Camera Link" className="w-9 h-9 rounded-full bg-white/80 border border-amber-300 flex items-center justify-center text-amber-950 hover:bg-neutral-950 hover:text-white transition shadow-sm backdrop-blur-sm">
                <Camera size={16} />
              </a>
              <a href="#" aria-label="Website Link" className="w-9 h-9 rounded-full bg-white/80 border border-amber-300 flex items-center justify-center text-amber-950 hover:bg-neutral-950 hover:text-white transition shadow-sm backdrop-blur-sm">
                <Globe size={16} />
              </a>
              <a href="#" aria-label="Share Link" className="w-9 h-9 rounded-full bg-white/80 border border-amber-300 flex items-center justify-center text-amber-950 hover:bg-neutral-950 hover:text-white transition shadow-sm backdrop-blur-sm">
                <Share2 size={16} />
              </a>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-4">
            <h4 className="text-xs font-bold uppercase tracking-wider text-amber-950">Get in Touch</h4>
