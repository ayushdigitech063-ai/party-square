...
export default function BirthdayProductDetail({
  params,
}: PageProps) {
  ...
  const product = birthdayProducts.find(
    (p) => p.id == productId
  );
...
const [relatedStart, setRelatedStart] = useState(0);
      ...
      <div className="min-h-screen bg-[#fbf8f3] flex items-center justify-center px-6">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-neutral-500">
            The birthday decoration product you are looking for does
            not exist.
          </p>
          ...
          <button
            type="button"
            onClick={() => router.back()}
            className="mt-6 bg-[#4b2014] text-white px-6 py-3 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-[#602a19] transition-colors"
          >
            Go Back
          </button>
        </div>
  ...
  const rating =
    (product as any).rating ?? 4.9;

  const reviewCount =
    (product as any).reviewCount ?? 184;

  const originalPrice =
    parsePrice((product as any).originalPrice) ||
  ...
  const features: string[] =
    (product as any).features?.length
  ...
  const relatedProducts = birthdayProducts.filter(
...
<div className="bg-white">
               ...
               <h2 className="font-serif font-bold text-[32px] sm:text-[40px] leading-[1.3] text-[#18100c] max-w-[850px]">
                  Turn Your Special Moments Into Magical Memories
                </h2>

              <p className="mt-5 text-[17px] sm:text-[18px] leading-8 text-neutral-600">
                  {product.description}
                </p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mt-9">
                  ...
                  <div className="min-h-[155px] bg-[#fff9e9] rounded-[14px] px-4 py-4 flex flex-col justify-center">
                  ...
                  <div className="min-h-[135px] bg-[#fff9e9] rounded-[14px] px-4 py-4 flex flex-col justify-center">
                    ...
                    <p className="mt-5 text-[16px] font-bold text-neutral-900">
                      Verified
                    </p>
              ...
              <div className="bg-[#fff9e9] border border-[#eadba7] rounded-[13px] p-8">

                <h3 className="font-serif font-bold text-[18px] text-[#18100c] mb-7">
                  What&apos;s Included
                </h3>
            ...
            <section className="mt-5 grid grid-cols-1 lg:grid-cols-2 gap-4">
              ...
              <div className="bg-[#fff9e9] border border-[#eadba7] rounded-[13px] p-6 sm:p-8 flex flex-col justify-center min-h-[220px]">
                ...
                <p className="mt-3 text-[10px] leading-5 text-neutral-500 max-w-[450px]">
                  Create beautiful birthday celebrations with
        ...
        {activeTab === "faq" && (
          <section className="mt-5 bg-white border border-[#e1ddd7] rounded-[13px] p-6">
            ...
            <p className="text-sm leading-6 text-neutral-600">
              Have questions about birthday setup timing,
              customization, themes, or delivery? Contact our team
              before booking and we&apos;ll help you with everything.
            </p>
...
<span className="text-[15px] font-extrabold text-[#17100c] whitespace-nowrap">
  ₹{itemPrice.toLocaleString()}
              ...
              <div className="flex items-center gap-2">
                ...
                {/* BOOK */}
                <Link
                  href={`/services/birthday/${item.id}`}
