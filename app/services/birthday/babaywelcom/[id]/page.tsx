...
import {babyWelcomeDecor, cartoonAndToyDecor} from "../page";
...
export default function YoungBirthdayPage({ params }: PageProps) {
  ...
  const productId = Number(resolvedParams.id);
   const product = babyWelcomeDecor.find((item) => item.id == productId) || cartoonAndToyDecor.find((item) => item.id == productId);
